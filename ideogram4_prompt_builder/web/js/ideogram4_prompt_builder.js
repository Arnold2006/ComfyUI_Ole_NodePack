...
const TPL_DIR = "ideogram4_prompt_builder/templates";
...
app.registerExtension({
  name: "Ideogram4PromptBuilder.Editor",

  async beforeRegisterNodeDef(nodeType, nodeData) {
    if (nodeData?.name !== "Ideogram4PromptBuilderOLE") return;
    injectStyle();
    ...
    chainCallback(nodeType.prototype, "onNodeCreated", function () {
      ...
      tplBtn.title = "Save / load the caption JSON as templates (stored on the server ComfyUI\\user\\default\\ideogram4_prompt_builder)";
      stopProp(tplBtn);
      ...
      // Optional reference image as the canvas background.
